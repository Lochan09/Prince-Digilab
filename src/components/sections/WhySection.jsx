const WHY_STATS = [
  { num: '72+',  label: 'Unique NPL Pad Designs' },
  { num: '12+',  label: 'Luxury Combo Options' },
  { num: '5',    label: 'LED Box Collections' },
  { num: '15+',  label: 'Suitcase Package Styles' },
  { num: '100%', label: 'Custom Personalization' },
];
